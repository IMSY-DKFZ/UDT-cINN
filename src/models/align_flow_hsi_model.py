...
class CouplingLayer(nn.Module):
    ...
    def __init__(self, in_channels, mid_channels, num_blocks, mask_type, reverse_mask):
        ...
        self.st_norm = nn.BatchNorm1d(norm_channels, affine=False)
        self.st_net = subnet(in_channels, mid_channels, out_channels)
...
class Flow2Flow(nn.Module):
    ...
    def __init__(self, args):
        ...
        if self.is_training:
            ...
            self.d_tgt = DiscriminatorHSI(args)  # Answers Q "is this tgt image real?"
            self.d_src = DiscriminatorHSI(args)  # Answers Q "is this src image real?"
