    ...
    def get_new_config(self):
        ...
        if new_config.data.data_dir_a == "test_dir_a" and new_config.data.data_dir_b == "test_dir_b":
            ...
            if data_set_name == "mnist_usps" or "mnist" in new_config.experiment_name:
                ...
                if data_set_name == "sim_hsi":
                    new_config.data.data_dir_a = os.path.join(data_base_path, "HSI_Data", "L1_normalized", "sampled")
                    new_config.data.data_dir_b = os.path.join(data_base_path, "HSI_Data", "L1_normalized", "adapted")
            else:
