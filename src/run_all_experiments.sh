...
export HSI_DATA_PATH="$DATA_BASE_PATH/HSI_Data"
...
cp -r "$cINN_DY_PATH_HSI" "$SAVE_DATA_PATH/results/inn"
cp -r "$UNIT_Y_PATH_HSI" "$SAVE_DATA_PATH/results/unit"
...
#cp -r "$cINN_D_PATH_HSI" "$SAVE_DATA_PATH/results/inn"
#cp -r "$UNIT_PATH_HSI" "$SAVE_DATA_PATH/results/unit"
...
#cp -r "$cINN_WG_PATH_HSI" "$SAVE_DATA_PATH/results/inn"
#cp -r "$CYCLEGAN_PATH_HSI" "$SAVE_DATA_PATH/results/unit"
