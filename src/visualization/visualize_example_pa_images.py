...
col_bar(img)
plt.savefig("/home/kris/Work/Data/domain_adaptation_simulations/HSI_Data/organ_data/figures/PAI_comparison_sim.svg")
# plt.show()
plt.close()
...
plt.gca().add_artist(scale_bar)
col_bar(img)
plt.savefig("/home/kris/Work/Data/domain_adaptation_simulations/HSI_Data/organ_data/figures/PAI_comparison_sim2real.svg")
# plt.show()
plt.close()
...
plt.gca().add_artist(scale_bar)
col_bar(img)
plt.savefig("/home/kris/Work/Data/domain_adaptation_simulations/HSI_Data/organ_data/figures/PAI_comparison_real.svg")
# plt.show()
plt.close()
